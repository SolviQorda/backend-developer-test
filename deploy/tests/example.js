...
(function(exports) {exports._awaitSignIn = function () {
...
})(PS["Example.Effects.Aff.Ajax.Component"] = PS["Example.Effects.Aff.Ajax.Component"] || {});
(function(exports) {
    "use strict";
...
(function(exports) {
  ...
  var monadStateHalogenM = new Control_Monad_State_Class.MonadState(function () {
      ...
      return HalogenM(Control_Monad_Free.liftF(State.create($131)));
  });
  var monadEffectHalogenM = function (dictMonadEffect) {
      return new Effect_Class.MonadEffect(function () {
          return monadHalogenM;
      }, function ($134) {
          return HalogenM(Control_Monad_Free.liftF(Lift.create(Effect_Class.liftEffect(dictMonadEffect)($134))));
      });
  };
  var monadAffHalogenM = function (dictMonadAff) {
      return new Effect_Aff_Class.MonadAff(function () {
          ...
          return HalogenM(Control_Monad_Free.liftF(Lift.create(Effect_Aff_Class.liftAff(dictMonadAff)($135))));
      });
  };
...
(function(exports) {
  ...
  var Handle = (function () {
      function Handle(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      Handle.create = function (value0) {
          return function (value1) {
              return new Handle(value0, value1);
          };
      };
      return Handle;
  })();
...
(function(exports) {
  ...
  var component = (function () {
      var go = function (spec) {
          return {
              initialState: spec.initialState,
              render: spec.render,
              "eval": function (v) {
                  if (v instanceof Halogen_Query_HalogenQ.Initialize) {
                      return Data_Functor.voidLeft(Halogen_Query_HalogenM.functorHalogenM)(Data_Foldable.traverse_(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Foldable.foldableMaybe)(spec["eval"])(spec.initializer))(v.value0);
                  };
                  if (v instanceof Halogen_Query_HalogenQ.Finalize) {
                      return Data_Functor.voidLeft(Halogen_Query_HalogenM.functorHalogenM)(Data_Foldable.traverse_(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Foldable.foldableMaybe)(spec["eval"])(spec.finalizer))(v.value0);
                  };
                  if (v instanceof Halogen_Query_HalogenQ.Receive) {
                      return Data_Functor.voidLeft(Halogen_Query_HalogenM.functorHalogenM)(Data_Foldable.traverse_(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Foldable.foldableMaybe)(spec["eval"])(spec.receiver(v.value0)))(v.value1);
                  };
                  if (v instanceof Halogen_Query_HalogenQ.Handle) {
                      return Data_Functor.voidLeft(Halogen_Query_HalogenM.functorHalogenM)(spec["eval"](v.value0))(v.value1);
                  };
                  if (v instanceof Halogen_Query_HalogenQ.Request) {
                      return spec["eval"](v.value0);
                  };
                  throw new Error("Failed pattern match at Halogen.Component line 102, column 15 - line 107, column 37: " + [ v.constructor.name ]);
              }
          };
      };
      return function ($24) {
          return mkComponent(go($24));
      };
  })();
...
(function(exports) {
    "use strict";
  var $foreign = PS["Example.Effects.Aff.Ajax.Component"];
  var Control_Applicative = PS["Control.Applicative"];
  var Control_Bind = PS["Control.Bind"];
  var Control_Category = PS["Control.Category"];
  var Control_Monad_State_Class = PS["Control.Monad.State.Class"];
  ...
  var Network_HTTP_RequestHeader = PS["Network.HTTP.RequestHeader"];
  var Prelude = PS["Prelude"];                 
  var SetProfileName = (function () {
      function SetProfileName(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      SetProfileName.create = function (value0) {
          return function (value1) {
              return new SetProfileName(value0, value1);
          };
      };
      return SetProfileName;
  })();
  var SetApiBaseUrl = (function () {
      function SetApiBaseUrl(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      SetApiBaseUrl.create = function (value0) {
          return function (value1) {
              return new SetApiBaseUrl(value0, value1);
          };
      };
      return SetApiBaseUrl;
  })();
  var SetProfileLongitude = (function () {
      function SetProfileLongitude(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      SetProfileLongitude.create = function (value0) {
          return function (value1) {
              return new SetProfileLongitude(value0, value1);
          };
      };
      return SetProfileLongitude;
  })();
  var SetProfileLatitude = (function () {
      function SetProfileLatitude(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      SetProfileLatitude.create = function (value0) {
          return function (value1) {
              return new SetProfileLatitude(value0, value1);
          };
      };
      return SetProfileLatitude;
  })();
  var SetProfileGames = (function () {
      function SetProfileGames(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      SetProfileGames.create = function (value0) {
          return function (value1) {
              return new SetProfileGames(value0, value1);
          };
      };
      return SetProfileGames;
  })();
  var SetProfileAge = (function () {
      function SetProfileAge(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      SetProfileAge.create = function (value0) {
          return function (value1) {
              return new SetProfileAge(value0, value1);
          };
      };
      return SetProfileAge;
  })();
  var SetProfileHost = (function () {
      function SetProfileHost(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      SetProfileHost.create = function (value0) {
          return function (value1) {
              return new SetProfileHost(value0, value1);
          };
      };
      return SetProfileHost;
  })();
  var SetHost = (function () {
      function SetHost(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      SetHost.create = function (value0) {
          return function (value1) {
              return new SetHost(value0, value1);
          };
      };
      return SetHost;
  })();
  var SetPlayerId = (function () {
      function SetPlayerId(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      SetPlayerId.create = function (value0) {
          return function (value1) {
              return new SetPlayerId(value0, value1);
          };
      };
      return SetPlayerId;
  })();
  var RegisterProfile = (function () {
      function RegisterProfile(value0) {
          this.value0 = value0;
      };
      RegisterProfile.create = function (value0) {
          return new RegisterProfile(value0);
      };
      return RegisterProfile;
  })();
  var UpdateProfile = (function () {
      function UpdateProfile(value0) {
          this.value0 = value0;
      };
      UpdateProfile.create = function (value0) {
          return new UpdateProfile(value0);
      };
      return UpdateProfile;
  })();
  var GetProfile = (function () {
      function GetProfile(value0) {
          this.value0 = value0;
      };
      GetProfile.create = function (value0) {
          return new GetProfile(value0);
      };
      return GetProfile;
  })();
  var UpdateHost = (function () {
      function UpdateHost(value0) {
          this.value0 = value0;
      };
      UpdateHost.create = function (value0) {
          return new UpdateHost(value0);
      };
      return UpdateHost;
  })();
  var GetHost = (function () {
      function GetHost(value0) {
          this.value0 = value0;
      };
      GetHost.create = function (value0) {
          return new GetHost(value0);
      };
      return GetHost;
  })();
  var GetPlayers = (function () {
      function GetPlayers(value0) {
          this.value0 = value0;
      };
      GetPlayers.create = function (value0) {
          return new GetPlayers(value0);
      };
      return GetPlayers;
  })();
  var PostRequest = (function () {
      function PostRequest(value0) {
          this.value0 = value0;
      };
      PostRequest.create = function (value0) {
          return new PostRequest(value0);
      };
      return PostRequest;
  })();
  var GetRequests = (function () {
      function GetRequests(value0) {
          this.value0 = value0;
      };
      GetRequests.create = function (value0) {
          return new GetRequests(value0);
      };
      return GetRequests;
  })();
  var AwaitSignIn = (function () {
      function AwaitSignIn(value0) {
          this.value0 = value0;
      };
      AwaitSignIn.create = function (value0) {
          return new AwaitSignIn(value0);
      };
      return AwaitSignIn;
  })();
  var awaitSignIn = Effect_Aff_Compat.fromEffectFnAff($foreign._awaitSignIn(Data_Unit.unit));
  var ui = (function () {
      var requestifyProfile = function (p) {
          return {
              name: p.name,
              age: Global.readFloat(p.age),
              longitude: Global.readFloat(p.longitude),
              latitude: Global.readFloat(p.latitude),
              games: Data_Either.either(Data_Function["const"]([  ]))(Control_Category.identity(Control_Category.categoryFn))(Control_Bind.bindFlipped(Data_Either.bindEither)(Data_Argonaut_Decode_Class.decodeJson(Data_Argonaut_Decode_Class.decodeArray(Data_Argonaut_Decode_Class.decodeJsonString)))(Data_Argonaut_Parser.jsonParser(p.games))),
              availableToHost: p.host
          };
      };
      var render = function (st) {
          return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.form_([ Halogen_HTML_Elements.h1_([ Halogen_HTML_Core.text("Tests") ]), Halogen_HTML_Elements.label_([ Halogen_HTML_Elements.div_([ Halogen_HTML_Core.text("API base URL:") ]), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.value(st.apiBaseUrl), Halogen_HTML_Events.onValueInput(Halogen_HTML_Events.input(SetApiBaseUrl.create)) ]) ]) ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("g-signin2"), Halogen_HTML_Properties.attr("data-onsuccess")("onSignIn") ])([  ]) ]), Halogen_HTML_Elements.p_(Data_Maybe.maybe([  ])(function (idToken) {
              return [ Halogen_HTML_Elements.textarea([ Halogen_HTML_Properties.value("IdToken: " + idToken) ]) ];
          })(st.idToken)), Halogen_HTML_Elements.form_([ Halogen_HTML_Elements.h1_([ Halogen_HTML_Core.text("Profile") ]), Halogen_HTML_Elements.label_([ Halogen_HTML_Elements.div_([ Halogen_HTML_Core.text("Name:") ]), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.value(st.profile.name), Halogen_HTML_Events.onValueInput(Halogen_HTML_Events.input(SetProfileName.create)) ]) ]), Halogen_HTML_Elements.label_([ Halogen_HTML_Elements.div_([ Halogen_HTML_Core.text("Longitude:") ]), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.value(st.profile.longitude), Halogen_HTML_Events.onValueInput(Halogen_HTML_Events.input(SetProfileLongitude.create)) ]) ]), Halogen_HTML_Elements.label_([ Halogen_HTML_Elements.div_([ Halogen_HTML_Core.text("Latitude:") ]), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.value(st.profile.latitude), Halogen_HTML_Events.onValueInput(Halogen_HTML_Events.input(SetProfileLatitude.create)) ]) ]), Halogen_HTML_Elements.label_([ Halogen_HTML_Elements.div_([ Halogen_HTML_Core.text("Games:") ]), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.value(st.profile.games), Halogen_HTML_Events.onValueInput(Halogen_HTML_Events.input(SetProfileGames.create)) ]) ]), Halogen_HTML_Elements.label_([ Halogen_HTML_Elements.div_([ Halogen_HTML_Core.text("Age:") ]), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.value(st.profile.age), Halogen_HTML_Events.onValueInput(Halogen_HTML_Events.input(SetProfileAge.create)) ]) ]), Halogen_HTML_Elements.label_([ Halogen_HTML_Elements.div_([ Halogen_HTML_Core.text("Host:") ]), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputCheckbox.value), Halogen_HTML_Properties.checked(st.profile.host), Halogen_HTML_Events.onChecked(Halogen_HTML_Events.input(SetProfileHost.create)) ]) ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Elements.button([ Halogen_HTML_Properties.disabled(st.loading), Halogen_HTML_Properties.type_(Halogen_HTML_Core.buttonTypeIsProp)(DOM_HTML_Indexed_ButtonType.ButtonButton.value), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(RegisterProfile.create)) ])([ Halogen_HTML_Core.text("POST") ]), Halogen_HTML_Elements.button([ Halogen_HTML_Properties.disabled(st.loading), Halogen_HTML_Properties.type_(Halogen_HTML_Core.buttonTypeIsProp)(DOM_HTML_Indexed_ButtonType.ButtonButton.value), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(UpdateProfile.create)) ])([ Halogen_HTML_Core.text("PUT") ]), Halogen_HTML_Elements.button([ Halogen_HTML_Properties.disabled(st.loading), Halogen_HTML_Properties.type_(Halogen_HTML_Core.buttonTypeIsProp)(DOM_HTML_Indexed_ButtonType.ButtonButton.value), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(GetProfile.create)) ])([ Halogen_HTML_Core.text("GET") ]) ]), Halogen_HTML_Elements.form_([ Halogen_HTML_Elements.h1_([ Halogen_HTML_Core.text("Host") ]), Halogen_HTML_Elements.label_([ Halogen_HTML_Elements.div_([ Halogen_HTML_Core.text("Host:") ]), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputCheckbox.value), Halogen_HTML_Properties.checked(st.host), Halogen_HTML_Events.onChecked(Halogen_HTML_Events.input(SetHost.create)) ]) ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Elements.button([ Halogen_HTML_Properties.disabled(st.loading), Halogen_HTML_Properties.type_(Halogen_HTML_Core.buttonTypeIsProp)(DOM_HTML_Indexed_ButtonType.ButtonButton.value), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(UpdateHost.create)) ])([ Halogen_HTML_Core.text("PUT") ]), Halogen_HTML_Elements.button([ Halogen_HTML_Properties.disabled(st.loading), Halogen_HTML_Properties.type_(Halogen_HTML_Core.buttonTypeIsProp)(DOM_HTML_Indexed_ButtonType.ButtonButton.value), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(GetHost.create)) ])([ Halogen_HTML_Core.text("GET") ]) ]) ]), Halogen_HTML_Elements.form_([ Halogen_HTML_Elements.h1_([ Halogen_HTML_Core.text("Players") ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Elements.button([ Halogen_HTML_Properties.disabled(st.loading), Halogen_HTML_Properties.type_(Halogen_HTML_Core.buttonTypeIsProp)(DOM_HTML_Indexed_ButtonType.ButtonButton.value), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(GetPlayers.create)) ])([ Halogen_HTML_Core.text("GET") ]) ]) ]), Halogen_HTML_Elements.form_([ Halogen_HTML_Elements.h1_([ Halogen_HTML_Core.text("Requests") ]), Halogen_HTML_Elements.label_([ Halogen_HTML_Elements.div_([ Halogen_HTML_Core.text("Player Id:") ]), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.value(st.playerId), Halogen_HTML_Events.onValueInput(Halogen_HTML_Events.input(SetPlayerId.create)) ]) ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Elements.button([ Halogen_HTML_Properties.disabled(st.loading), Halogen_HTML_Properties.type_(Halogen_HTML_Core.buttonTypeIsProp)(DOM_HTML_Indexed_ButtonType.ButtonButton.value), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(PostRequest.create)) ])([ Halogen_HTML_Core.text("POST") ]), Halogen_HTML_Elements.button([ Halogen_HTML_Properties.disabled(st.loading), Halogen_HTML_Properties.type_(Halogen_HTML_Core.buttonTypeIsProp)(DOM_HTML_Indexed_ButtonType.ButtonButton.value), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(GetRequests.create)) ])([ Halogen_HTML_Core.text("GET") ]) ]) ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text((function () {
              if (st.loading) {
                  return "Working...";
              };
              return "";
              ...
              if (st.result instanceof Data_Maybe.Just) {
                  return [ Halogen_HTML_Elements.h2_([ Halogen_HTML_Core.text("Response:") ]), Halogen_HTML_Elements.textarea([ Halogen_HTML_Properties.value(st.result.value0) ]) ];
              };
              throw new Error("Failed pattern match at Example.Effects.Aff.Ajax.Component line 263, column 15 - line 270, column 20: " + [ st.result.constructor.name ]);
          })()) ]) ]);
      };
      var initialState = {
          loading: false,
          ...
          idToken: Data_Maybe.Nothing.value
      };
      var $$eval = function (v) {
          if (v instanceof SetProfileName) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                  ...
                  $74.profile = (function () {
                      var $71 = {};
                      for (var $72 in state.profile) {
                          if ({}.hasOwnProperty.call(state.profile, $72)) {
                              $71[$72] = state["profile"][$72];
                          };
                      };
                      $71.name = v.value0;
                      return $71;
          ...
          if (v instanceof SetProfileLongitude) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                  var $82 = {};
                  for (var $83 in state) {
                  ...
                  $82.profile = (function () {
                      var $79 = {};
                      for (var $80 in state.profile) {
                          if ({}.hasOwnProperty.call(state.profile, $80)) {
                              $79[$80] = state["profile"][$80];
                          };
                      };
                      $79.longitude = v.value0;
                      return $79;
                  })();
                  return $82;
              }))(function () {
          ...
          if (v instanceof SetProfileLatitude) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                  var $90 = {};
                  for (var $91 in state) {
                  ...
                  $90.profile = (function () {
                      var $87 = {};
                      for (var $88 in state.profile) {
                          if ({}.hasOwnProperty.call(state.profile, $88)) {
                              $87[$88] = state["profile"][$88];
                          };
                      };
                      $87.latitude = v.value0;
                      return $87;
                  })();
                  return $90;
              }))(function () {
          ...
          if (v instanceof SetProfileGames) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                  var $98 = {};
                  for (var $99 in state) {
                  ...
                  $98.profile = (function () {
                      var $95 = {};
                      for (var $96 in state.profile) {
                          if ({}.hasOwnProperty.call(state.profile, $96)) {
                              $95[$96] = state["profile"][$96];
                          };
                      };
                      $95.games = v.value0;
                      return $95;
          ...
          if (v instanceof SetProfileAge) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                  ...
                  $106.profile = (function () {
                      var $103 = {};
                      for (var $104 in state.profile) {
                          if ({}.hasOwnProperty.call(state.profile, $104)) {
                              $103[$104] = state["profile"][$104];
                          };
                      };
                      $103.age = v.value0;
                      return $103;
          ...
          if (v instanceof SetProfileHost) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                  var $114 = {};
                  ...
                  $114.profile = (function () {
                      var $111 = {};
                      for (var $112 in state.profile) {
                          if ({}.hasOwnProperty.call(state.profile, $112)) {
                              $111[$112] = state["profile"][$112];
                          };
                      };
                      $111.host = v.value0;
                      return $111;
          ...
          if (v instanceof SetPlayerId) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                  ...
                  $124.playerId = v.value0;
                  return $124;
              }))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
              });
          };
          if (v instanceof SetApiBaseUrl) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                  var $129 = {};
                  ...
                  $129.apiBaseUrl = v.value0;
                  return $129;
              }))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
              });
          };
          if (v instanceof RegisterProfile) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                      ...
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Effect_Aff_Class.monadAffAff))(Network_HTTP_Affjax.affjax(Network_HTTP_Affjax_Response.string)({
                          method: new Data_Either.Left(Data_HTTP_Method.POST.value),
                          url: v1.apiBaseUrl + "/register",
                          headers: Data_Maybe.maybe([  ])(function ($211) {
                              return Control_Applicative.pure(Control_Applicative.applicativeArray)(Network_HTTP_RequestHeader.RequestHeader.create("Authorization")((function (v3) {
                                  return "Bearer: " + v3;
                              })($211)));
                          })(v1.idToken),
                          content: Data_Maybe.Just.create(Network_HTTP_Affjax_Request.json(Data_Argonaut_Encode_Class.encodeJson(Data_Argonaut_Encode_Class.encodeRecord(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeJsonJNumber)(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeJsonJBoolean)(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeJsonArray(Data_Argonaut_Encode_Class.encodeJsonJString))(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeJsonJNumber)(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeJsonJNumber)(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeJsonJString)(Data_Argonaut_Encode_Class.gEncodeJsonNil)(new Data_Symbol.IsSymbol(function () {
                              return "name";
                              ...
                              return "availableToHost";
                          }))())(new Data_Symbol.IsSymbol(function () {
                              return "age";
                          }))())())(requestifyProfile(v1.profile)))),
                          ...
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                              ...
                              $139.loading = false;
                              $139.result = new Data_Maybe.Just(v2.response);
                              return $139;
                          }))(function () {
          ...
          if (v instanceof PostRequest) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                      ...
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Effect_Aff_Class.monadAffAff))(Network_HTTP_Affjax.affjax(Network_HTTP_Affjax_Response.string)({
                          method: new Data_Either.Left(Data_HTTP_Method.POST.value),
                          url: v1.apiBaseUrl + "/join",
                          headers: Data_Maybe.maybe([  ])(function ($212) {
                              return Control_Applicative.pure(Control_Applicative.applicativeArray)(Network_HTTP_RequestHeader.RequestHeader.create("Authorization")((function (v3) {
                                  return "Bearer: " + v3;
                              })($212)));
                          })(v1.idToken),
                          content: Data_Maybe.Just.create(Network_HTTP_Affjax_Request.json(Data_Argonaut_Encode_Class.encodeJson(Data_Argonaut_Encode_Class.encodeJsonJString)(v1.playerId))),
                          username: Network_HTTP_Affjax.defaultRequest.username,
                          password: Network_HTTP_Affjax.defaultRequest.password,
                          withCredentials: Network_HTTP_Affjax.defaultRequest.withCredentials
                      })))(function (v2) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                              var $148 = {};
                              for (var $149 in v3) {
                                  if ({}.hasOwnProperty.call(v3, $149)) {
                                      $148[$149] = v3[$149];
                                  };
                              };
                              $148.loading = false;
                              $148.result = new Data_Maybe.Just(v2.response);
                              return $148;
                          }))(function () {
                              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
                          });
              ...
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                      ...
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Effect_Aff_Class.monadAffAff))(Network_HTTP_Affjax.affjax(Network_HTTP_Affjax_Response.string)({
                          ...
                          url: v1.apiBaseUrl + "/register",
                          headers: Data_Maybe.maybe([  ])(function ($213) {
                              return Control_Applicative.pure(Control_Applicative.applicativeArray)(Network_HTTP_RequestHeader.RequestHeader.create("Authorization")((function (v3) {
                                  return "Bearer: " + v3;
                              })($213)));
                          })(v1.idToken),
                          ...
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                              ...
                              $157.loading = false;
                              $157.result = new Data_Maybe.Just(v2.response);
                              return $157;
                          }))(function () {
                              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
                          });
          ...
          if (v instanceof UpdateHost) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                      ...
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Effect_Aff_Class.monadAffAff))(Network_HTTP_Affjax.affjax(Network_HTTP_Affjax_Response.string)({
                          method: new Data_Either.Left(Data_HTTP_Method.PUT.value),
                          url: v1.apiBaseUrl + "/host",
                          headers: Data_Maybe.maybe([  ])(function ($214) {
                              return Control_Applicative.pure(Control_Applicative.applicativeArray)(Network_HTTP_RequestHeader.RequestHeader.create("Authorization")((function (v3) {
                                  return "Bearer: " + v3;
                              })($214)));
                          })(v1.idToken),
                          content: Data_Maybe.Just.create(Network_HTTP_Affjax_Request.json(Data_Argonaut_Encode_Class.encodeJson(Data_Argonaut_Encode_Class.encodeJsonJBoolean)(v1.host))),
                          username: Network_HTTP_Affjax.defaultRequest.username,
                          password: Network_HTTP_Affjax.defaultRequest.password,
                          withCredentials: Network_HTTP_Affjax.defaultRequest.withCredentials
                      })))(function (v2) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                              var $166 = {};
                              for (var $167 in v3) {
                                  if ({}.hasOwnProperty.call(v3, $167)) {
                                      $166[$167] = v3[$167];
                                  };
                              };
                              $166.loading = false;
                              $166.result = new Data_Maybe.Just(v2.response);
                              return $166;
                          }))(function () {
                              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
                          });
              ...
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                      ...
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Effect_Aff_Class.monadAffAff))(Network_HTTP_Affjax.affjax(Network_HTTP_Affjax_Response.string)({
                          method: new Data_Either.Left(Data_HTTP_Method.GET.value),
                          url: v1.apiBaseUrl + "/register",
                          headers: Data_Maybe.maybe([  ])(function ($215) {
                              return Control_Applicative.pure(Control_Applicative.applicativeArray)(Network_HTTP_RequestHeader.RequestHeader.create("Authorization")((function (v3) {
                                  return "Bearer: " + v3;
                              })($215)));
                          })(v1.idToken),
                          ...
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                              var $175 = {};
                              for (var $176 in v3) {
                                  if ({}.hasOwnProperty.call(v3, $176)) {
                                      $175[$176] = v3[$176];
                                  };
                              };
                              $175.loading = false;
                              $175.result = new Data_Maybe.Just(v2.response);
                              return $175;
                          }))(function () {
                              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
                          });
              ...
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                      ...
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Effect_Aff_Class.monadAffAff))(Network_HTTP_Affjax.affjax(Network_HTTP_Affjax_Response.string)({
                          method: new Data_Either.Left(Data_HTTP_Method.GET.value),
                          url: v1.apiBaseUrl + "/host",
                          headers: Data_Maybe.maybe([  ])(function ($216) {
                              return Control_Applicative.pure(Control_Applicative.applicativeArray)(Network_HTTP_RequestHeader.RequestHeader.create("Authorization")((function (v3) {
                                  return "Bearer: " + v3;
                              })($216)));
                          })(v1.idToken),
                          ...
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                              var $184 = {};
                              for (var $185 in v3) {
                                  if ({}.hasOwnProperty.call(v3, $185)) {
                                      $184[$185] = v3[$185];
                                  };
                              };
                              $184.loading = false;
                              $184.result = new Data_Maybe.Just(v2.response);
                              return $184;
                          }))(function () {
                              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
                          });
          ...
          if (v instanceof GetPlayers) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                      ...
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Effect_Aff_Class.monadAffAff))(Network_HTTP_Affjax.affjax(Network_HTTP_Affjax_Response.string)({
                          method: new Data_Either.Left(Data_HTTP_Method.GET.value),
                          url: v1.apiBaseUrl + "/players",
                          headers: Data_Maybe.maybe([  ])(function ($217) {
                              return Control_Applicative.pure(Control_Applicative.applicativeArray)(Network_HTTP_RequestHeader.RequestHeader.create("Authorization")((function (v3) {
                                  return "Bearer: " + v3;
                              })($217)));
                          })(v1.idToken),
                          ...
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                              ...
                              $193.loading = false;
                              $193.result = new Data_Maybe.Just(v2.response);
                              return $193;
                          }))(function () {
                              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
                          });
              ...
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                      ...
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Effect_Aff_Class.monadAffAff))(Network_HTTP_Affjax.affjax(Network_HTTP_Affjax_Response.string)({
                          method: new Data_Either.Left(Data_HTTP_Method.GET.value),
                          url: v1.apiBaseUrl + "/join",
                          headers: Data_Maybe.maybe([  ])(function ($218) {
                              return Control_Applicative.pure(Control_Applicative.applicativeArray)(Network_HTTP_RequestHeader.RequestHeader.create("Authorization")((function (v3) {
                                  return "Bearer: " + v3;
                              })($218)));
                          })(v1.idToken),
                          ...
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                              var $202 = {};
                              for (var $203 in v3) {
                                  if ({}.hasOwnProperty.call(v3, $203)) {
                                      $202[$203] = v3[$203];
                                  };
                              };
                              $202.loading = false;
                              $202.result = new Data_Maybe.Just(v2.response);
                              return $202;
                          }))(function () {
                              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
                          });
          ...
          if (v instanceof AwaitSignIn) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.fork(Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Effect_Aff_Class.monadAffAff))(awaitSignIn))(function (v1) {
                  return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                      ...
                      $207.idToken = new Data_Maybe.Just(v1);
                      return $207;
                  });
              })))(function (v1) {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
          ...
          throw new Error("Failed pattern match at Example.Effects.Aff.Ajax.Component line 285, column 10 - line 425, column 12: " + [ v.constructor.name ]);
      };
      return Halogen_Component.component({
          ...
          initializer: new Data_Maybe.Just(Halogen_Query.action(AwaitSignIn.create)),
          finalizer: Data_Maybe.Nothing.value
      });
  })();
  exports["awaitSignIn"] = awaitSignIn;
  exports["SetProfileName"] = SetProfileName;
  exports["SetApiBaseUrl"] = SetApiBaseUrl;
  exports["SetProfileLongitude"] = SetProfileLongitude;
  exports["SetProfileLatitude"] = SetProfileLatitude;
  exports["SetProfileGames"] = SetProfileGames;
  exports["SetProfileAge"] = SetProfileAge;
  exports["SetProfileHost"] = SetProfileHost;
...
(function(exports) {
  ...
  var queueOrRun = function (ref) {
      return function (au) {
          return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Effect_Ref.read(ref)))(function (v) {
              ...
              throw new Error("Failed pattern match at Halogen.Aff.Driver.Eval line 193, column 33 - line 195, column 54: " + [ v.constructor.name ]);
          });
      };
  };
  ...
  var evalQ = function (render) {
      return function (ref) {
          return function (q) {
              return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Effect_Ref.read(ref)))(function (v) {
                  return evalM(render)(ref)(v["component"]["eval"](new Halogen_Query_HalogenQ.Request(q)));
              });
          };
      };
  };
                  ...
                  return function (v1) {
                      if (v1 instanceof Halogen_Query_HalogenM.State) {
                          return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Effect_Ref.read(ref)))(function (v2) {
                              ...
                              throw new Error("Failed pattern match at Halogen.Aff.Driver.Eval line 83, column 7 - line 89, column 21: " + [ v3.constructor.name ]);
                          });
                      };
                      ...
                      throw new Error("Failed pattern match at Halogen.Aff.Driver.Eval line 80, column 12 - line 144, column 33: " + [ v1.constructor.name ]);
                  };
              };
      ...
      return function (ref) {
          return function (v) {
              ...
              if (v instanceof Halogen_Query_Input.Action) {
                  return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Effect_Ref.read(ref)))(function (v1) {
                      return evalM(render)(ref)(v1["component"]["eval"](new Halogen_Query_HalogenQ.Handle(v.value0, Data_Unit.unit)));
                  });
              };
              throw new Error("Failed pattern match at Halogen.Aff.Driver.Eval line 49, column 20 - line 55, column 59: " + [ v.constructor.name ]);
          };
      };
  };
  exports["evalF"] = evalF;
                              ...
                              return Halogen_Component.unComponentSlot(function (slot) {
                                  return function __do() {
                                      ...
                                      var v1 = (function () {
                                          ...
                                          throw new Error("Failed pattern match at Halogen.Aff.Driver line 231, column 14 - line 245, column 7: " + [ v1.constructor.name ]);
                                      })();
                                      ...
                                      return Control_Bind.bind(Effect.bindEffect)(Effect_Ref.read(v1))(Halogen_Aff_Driver_State.renderStateX(Effect.functorEffect)(function (v3) {
                                          ...
                                          throw new Error("Failed pattern match at Halogen.Aff.Driver line 249, column 37 - line 251, column 50: " + [ v3.constructor.name ]);
                                      }))();
                                  };
                              });
                          };
                  ...
                  return function (ref) {
                      return function (q) {
                          return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Effect_Ref.read(disposed)))(function (v) {
                              ...
                              return Data_Functor.map(Effect_Aff.functorAff)(Data_Maybe.Just.create)(Halogen_Aff_Driver_Eval.evalQ(render)(ref)(q));
                          });
                      };
                  };
              };
...
(function(exports) {
  ...
  var Effect = PS["Effect"];
  var Effect_Aff = PS["Effect.Aff"];
  var Example_Effects_Aff_Ajax_Component = PS["Example.Effects.Aff.Ajax.Component"];
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (v) {
      return Halogen_VDom_Driver.runUI(Example_Effects_Aff_Ajax_Component.ui)(Data_Unit.unit)(v);
  }));
  exports["main"] = main;
})(PS["Example.Effects.Aff.Ajax.Main"] = PS["Example.Effects.Aff.Ajax.Main"] || {});
PS["Example.Effects.Aff.Ajax.Main"].main();